    ...
    <div className='w-full h-full bg-gradient-to-r from-[#1491d1] to-[#d80b3e]'>
      <div className="container mx-auto px-4 flex gap-4 pt-8 flex-col md:flex-row items-center justify-center h-[calc(100%-4rem)] ">
        <div className='text-center'>
          ...
          <Link to={'/'} className='flex items-center justify-center p-4 mt-4 border-2 rounded-md border-[#d80b3e] text-[#040d11] text-md md:text-lg font-bold'>Anasayfaya Dön</Link>
        </div>
        <Lottie
